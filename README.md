...
- `res://addons/dice_3d/demo/physics_roll_demo.tscn` - a UI-driven physics demo with a wide/tall roll box, gravity direction, gravity strength, roll strength, and dice type controls.
